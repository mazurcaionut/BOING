...
public class ClosedShape {
    ...
    /**
     * Variable used to pulse the shape between two sizes
     */
     ...
     * @param isPulsing True if the shape is pulsing, false if not.
     */
    ...
    /**
     * Sets the shape not to be pulsing
     */
    ...
    /**
     * @return True if the shape is pulsing, false otherwise
     * */
     ...
     * @param state The state of the pulsing movement
     */
